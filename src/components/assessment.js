...
class ClassComponent extends React.Component {
 render() {
   return <h1>Hello, world</h1>;
                            ...
                            <p className='fst-italic fs-6 px-5'>A question that many JavaScript and HTML coders might ask… How is HTML code working inside a JavaScript syntax? And the answer is: It is not JavaScript but a syntax extension to JavaScript called JSX.</p>
  ...
  return <button onClick={()=> console.log(Math.random())}> </button>
                    ...
                    <div className='d-flex mt-3 card-content'>
                        ...
                        <div className='image-holder'>
                            <img src={GitCheatSheet} alt='git codes' />
                        </div>
                    </div>
                </Card.Body>
            </Card>
