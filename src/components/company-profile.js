...
function CompanyProfile() {
    return (
        <div className='company-profile-container'>
            ...
            <div className='company-details mt-3 d-flex'>
                <div className='company-address'>
                    <h2><a target='_blank' className='address-map' href='https://g.page/lexmeet-legal-help-in-a-click?share' rel="noreferrer"><FaMapMarkerAlt />Address</a></h2>
                    <p>LexMeet, Inc.</p>
